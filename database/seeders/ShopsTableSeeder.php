...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'image' => 'storage\app\public\img\yakiniku.jpg'
        ];
        Shop::create($param);
        $param = [
            'name' => '戦慄',
            ...
            'image' => 'storage\app\public\img\izakaya.jpg'
        ];
        Shop::create($param);
        ...
        $param = [
            ...
            'image' => 'storage\app\public\img\italian.jpg'
        ];
        Shop::create($param);
        ...
        $param = [
            ...
            'image' => 'storage\app\public\img\ramen.jpg'
        ];
        Shop::create($param);
